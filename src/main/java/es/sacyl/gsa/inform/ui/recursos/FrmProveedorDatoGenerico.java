 ...
 * @author 06551256M
 */
public class FrmProveedorDatoGenerico extends FrmMasterVentana {

    private final TextField id = new ObjetosComunes().getTextField("Id");
    private TextArea valor = new ObjetosComunes().getTextArea("Valor");
    private ComboBox<String> tipoDatosComboBox = new CombosUi().getGrupoRamaCombo(ComboBean.PROVEEDORDATOGENERICO, null, null);
    ...
    public FrmProveedorDatoGenerico(ProveedorBean porveedorParam, DatoGenericoBean datoGenericoBean) {
        super();
        this.proveedorBean = porveedorParam;
        if (datoGenericoBean != null) {
            doControlBotones(datoGenericoBean);
            this.datoGenericoBean = datoGenericoBean;
        } else {
            doControlBotones(null);
            this.datoGenericoBean.setIdProveedor(proveedorBean.getId());
        }
        doVentana();
    ...
    public void doGrabar() {
        if (datoGenericoBinder.writeBeanIfValid(datoGenericoBean)) {
            datoGenericoBean.setIdProveedor(proveedorBean.getId());
            datoGenericoBean.setValoresAut();
            if (new ProveedorDatosDao().doGrabaDatos(datoGenericoBean) == true) {
    ...
    public void doBorrar() {
        final ConfirmDialog dialog = new ConfirmDialog(
                ...
                FrmMensajes.AVISOCONFIRMACIONACCIONBORRAR, () -> {
                    new ProveedorDatosDao().doBorraDatos(datoGenericoBean);
    ...
    public void doLimpiar() {
        ...
        datoGenericoBinder.readBean(datoGenericoBean);
        datoGenericoBean.setIdDatoAplicacion(proveedorBean.getId());
        fechaCambio.clear();
    ...
    public void doActualizaGrid() {
        datoGenericoBeanArray = new ProveedorDatosDao().getLista(null, proveedorBean);
    ...
    public void doComponenesAtributos() {
        ...
        this.titulo.setText("Datos y características de :" + proveedorBean.getNombre());
    ...
    public void doAlmacenaDato(InputStream stream, String filename) {
        ...
        new ProveedorDatosDao().doActualizaDatosFichero(datoGenericoBean);
